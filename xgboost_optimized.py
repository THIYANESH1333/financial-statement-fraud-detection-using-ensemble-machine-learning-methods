...
def optimize_xgboost_fast(X, y):
    """
    Fast XGBoost optimization using RandomizedSearchCV
    """
    print("Optimizing XGBoost hyperparameters (fast version)...")
    
    # Define parameter grid for optimization (reduced for speed)
    param_dist = {
...
def main():
    ...
    """
    print("="*60)
    print("XGBoost Fraud Detection - Numerical Features Only (Optimized)")
    print("="*60)
    ...
    # Optimize XGBoost (fast version)
    best_model = optimize_xgboost_fast(X_train_scaled, y_train)
