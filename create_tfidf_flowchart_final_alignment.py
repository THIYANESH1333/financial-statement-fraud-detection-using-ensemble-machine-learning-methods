...
def create_final_aligned_tfidf_flowchart():
    """Create a perfectly aligned TF-IDF flowchart with focus on second column alignment"""
    ...
    # Calculate precise positions with perfect column alignment
    ...
    # Save the image
    img.save('TF-IDF_Feature_Extraction_Process_Final_Alignment.png')
    print("Final aligned TF-IDF flowchart created successfully!")
    print("File saved: TF-IDF_Feature_Extraction_Process_Final_Alignment.png")

if __name__ == "__main__":
    create_final_aligned_tfidf_flowchart()
