...
def create_ultimate_aligned_tfidf_flowchart():
    """Create a perfectly aligned TF-IDF flowchart with mathematical precision"""
    ...
    # Calculate precise positions with mathematical alignment
    ...
    row2_y = 500
    total_row2_width = 2 * box_width + 1 * 150
    start_x_row2 = (width - total_row2_width) // 2
    
    corpus_x = start_x_row2
    tf_x = start_x_row2 + box_width + 150
    
    # Row 3: 1 box - IDF (centered)
    row3_y = 800
    idf_x = width // 2
    ...
    # Draw arrows with mathematical precision
    ...
    # Save the image
    img.save('TF-IDF_Feature_Extraction_Process_Ultimate_Alignment.png')
    print("Ultimate aligned TF-IDF flowchart created successfully!")
    print("File saved: TF-IDF_Feature_Extraction_Process_Ultimate_Alignment.png")

if __name__ == "__main__":
    create_ultimate_aligned_tfidf_flowchart()
