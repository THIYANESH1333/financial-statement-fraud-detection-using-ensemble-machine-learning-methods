...
def create_tfidf_flowchart_increased_gap():
    """Create a TF-IDF flowchart with increased gap from title"""
    ...
    # INCREASED GAP: Changed from 200 to 300 for more space after title
    ...
    # Save the image
    img.save('TF-IDF_Feature_Extraction_Process_Increased_Gap.png')
    print("TF-IDF flowchart with increased gap created successfully!")
    print("File saved: TF-IDF_Feature_Extraction_Process_Increased_Gap.png")

if __name__ == "__main__":
    create_tfidf_flowchart_increased_gap()
