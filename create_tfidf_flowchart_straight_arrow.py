...
def create_tfidf_flowchart_straight_arrow():
    """Create a TF-IDF flowchart with a straight arrow from Term Frequency to Corpus"""
    ...
    # Term Frequency -> Corpus (STRAIGHT ARROW - FIXED)
    # From left side of Term Frequency to right side of Corpus
    draw_arrow(tf_x - box_width//2, tf_x, corpus_x + box_width//2, row2_y)
    ...
    # Save the image
    img.save('TF-IDF_Feature_Extraction_Process_Straight_Arrow.png')
    print("TF-IDF flowchart with straight arrow created successfully!")
    print("File saved: TF-IDF_Feature_Extraction_Process_Straight_Arrow.png")

if __name__ == "__main__":
    create_tfidf_flowchart_straight_arrow()
