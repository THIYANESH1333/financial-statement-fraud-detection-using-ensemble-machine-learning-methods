...
def create_perfectly_aligned_tfidf_flowchart():
    ...
    # Font setup - keeping the good font sizes
    try:
    ...
    # Define precise box positions with perfect alignment
    ...
    # Save the image
    img.save('TF-IDF_Feature_Extraction_Process_Perfect_Alignment.png')
    print("Perfectly aligned TF-IDF flowchart created successfully!")
    print("File saved: TF-IDF_Feature_Extraction_Process_Perfect_Alignment.png")
